package cn.edu.buaa.crypto.encryption.Paillier;
...
public class PaillierEngine {
    ...
    public PaillierEngine(int bitLengthVal, int certainty) {
        Key(bitLengthVal, certainty);
    }
    public PaillierEngine() {
        Key(32, 64);
    }
    ...
    public static void main(String[] args) {
        PaillierEngine paillier = new PaillierEngine();
        //创建两个大整数m1,m2:
