...
public class DTrapGen {
    ...
    public Trapdoor_doctor generateDTrapdoor(CipherText ct, DecryptionKey sk) throws PolicySyntaxException, InvalidCipherTextException {
